 ...
 * 최종 수정자 : 
 * 최종 수정일 : 2023/10/29
 * 설명 : 1달 기준 보전 비용 집계를 담는 엔터티 
 * Version 1.0 : 생성
 */
public class MonthlyMaintenanceCost implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject monthlyMaintenanceCostMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "Report.MonthlyMaintenanceCost";
	...
	public MonthlyMaintenanceCost(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected MonthlyMaintenanceCost(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject monthlyMaintenanceCostMendixObject)
	{
		if (monthlyMaintenanceCostMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, monthlyMaintenanceCostMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.monthlyMaintenanceCostMendixObject = monthlyMaintenanceCostMendixObject;
	 ...
	 */
	public static report.proxies.MonthlyMaintenanceCost initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new report.proxies.MonthlyMaintenanceCost(context, mendixObject);
	}

	public static report.proxies.MonthlyMaintenanceCost load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return report.proxies.MonthlyMaintenanceCost.initialize(context, mendixObject);
	}

	public static java.util.List<report.proxies.MonthlyMaintenanceCost> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> report.proxies.MonthlyMaintenanceCost.initialize(context, obj))
	...
	{
		return monthlyMaintenanceCostMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final report.proxies.MonthlyMaintenanceCost that = (report.proxies.MonthlyMaintenanceCost) obj;

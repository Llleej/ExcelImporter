 ...
 * 최종 수정자 : 
 * 최종 수정일 : 2023/10/29
 * 설명 : 1일 기준 보전 비용 집계를 담는 엔터티 
 * Version 1.0 : 생성
 */
public class DailyMaintenanceCost implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject dailyMaintenanceCostMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "Report.DailyMaintenanceCost";
	...
	public DailyMaintenanceCost(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected DailyMaintenanceCost(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject dailyMaintenanceCostMendixObject)
	{
		if (dailyMaintenanceCostMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, dailyMaintenanceCostMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.dailyMaintenanceCostMendixObject = dailyMaintenanceCostMendixObject;
	 ...
	 */
	public static report.proxies.DailyMaintenanceCost initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new report.proxies.DailyMaintenanceCost(context, mendixObject);
	}

	public static report.proxies.DailyMaintenanceCost load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return report.proxies.DailyMaintenanceCost.initialize(context, mendixObject);
	}

	public static java.util.List<report.proxies.DailyMaintenanceCost> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> report.proxies.DailyMaintenanceCost.initialize(context, obj))
	...
	{
		return dailyMaintenanceCostMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final report.proxies.DailyMaintenanceCost that = (report.proxies.DailyMaintenanceCost) obj;

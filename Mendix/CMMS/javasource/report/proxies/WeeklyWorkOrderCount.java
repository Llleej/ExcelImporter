 ...
 * Version 1.0 : 생성
 */
public class WeeklyWorkOrderCount implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject weeklyWorkOrderCountMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "Report.WeeklyWorkOrderCount";
	...
	public WeeklyWorkOrderCount(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected WeeklyWorkOrderCount(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject weeklyWorkOrderCountMendixObject)
	{
		if (weeklyWorkOrderCountMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, weeklyWorkOrderCountMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.weeklyWorkOrderCountMendixObject = weeklyWorkOrderCountMendixObject;
	 ...
	 */
	public static report.proxies.WeeklyWorkOrderCount initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new report.proxies.WeeklyWorkOrderCount(context, mendixObject);
	}

	public static report.proxies.WeeklyWorkOrderCount load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return report.proxies.WeeklyWorkOrderCount.initialize(context, mendixObject);
	}

	public static java.util.List<report.proxies.WeeklyWorkOrderCount> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> report.proxies.WeeklyWorkOrderCount.initialize(context, obj))
	...
	{
		return weeklyWorkOrderCountMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final report.proxies.WeeklyWorkOrderCount that = (report.proxies.WeeklyWorkOrderCount) obj;

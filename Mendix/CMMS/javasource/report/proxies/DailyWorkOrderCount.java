 ...
 * Version 1.0 : 생성
 */
public class DailyWorkOrderCount implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject dailyWorkOrderCountMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "Report.DailyWorkOrderCount";
	...
	public DailyWorkOrderCount(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected DailyWorkOrderCount(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject dailyWorkOrderCountMendixObject)
	{
		if (dailyWorkOrderCountMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, dailyWorkOrderCountMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.dailyWorkOrderCountMendixObject = dailyWorkOrderCountMendixObject;
	 ...
	 */
	public static report.proxies.DailyWorkOrderCount initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new report.proxies.DailyWorkOrderCount(context, mendixObject);
	}

	public static report.proxies.DailyWorkOrderCount load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return report.proxies.DailyWorkOrderCount.initialize(context, mendixObject);
	}

	public static java.util.List<report.proxies.DailyWorkOrderCount> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> report.proxies.DailyWorkOrderCount.initialize(context, obj))
	...
	{
		return dailyWorkOrderCountMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final report.proxies.DailyWorkOrderCount that = (report.proxies.DailyWorkOrderCount) obj;

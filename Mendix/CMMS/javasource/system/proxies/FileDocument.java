...
public class FileDocument implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Equipment_Management.EquipmentEDMFile", mendixObject.getType())) {
			return equipment_management.proxies.EquipmentEDMFile.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyPage.Files", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("GlobalSearch.IndexZipData", mendixObject.getType())) {
			return globalsearch.proxies.IndexZipData.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Material_Management.MaterialEDMS", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("Work_Management.ResultFile", mendixObject.getType())) {
			return work_management.proxies.ResultFile.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Monitoring.SensorImage", mendixObject.getType())) {

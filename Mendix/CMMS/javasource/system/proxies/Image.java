...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Material_Management.BusinessPartnerPicture", mendixObject.getType())) {
			return material_management.proxies.BusinessPartnerPicture.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Equipment_Management.EquipmentEDMFileImage", mendixObject.getType())) {
			return equipment_management.proxies.EquipmentEDMFileImage.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Equipment_Management.EquipmentImage", mendixObject.getType())) {
			return equipment_management.proxies.EquipmentImage.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Equipment_Management.EquipmentMovementImage", mendixObject.getType())) {
			return equipment_management.proxies.EquipmentMovementImage.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Work_Management.FieldPhoto", mendixObject.getType())) {
			return work_management.proxies.FieldPhoto.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Material_Management.MaterialImage", mendixObject.getType())) {
			return material_management.proxies.MaterialImage.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("CMMS_Administration.ProfilePhoto", mendixObject.getType())) {
			return cmms_administration.proxies.ProfilePhoto.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Work_Management.ResultImage", mendixObject.getType())) {

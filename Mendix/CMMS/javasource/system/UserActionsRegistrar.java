...
public class UserActionsRegistrar
{
  public void registerActions(IActionRegistrator registrator)
  {
    ...
    registrator.registerUserAction(globalsearch.actions.AfterStartup.class);
    registrator.registerUserAction(globalsearch.actions.BatchDeleteIndexes.class);
    registrator.registerUserAction(globalsearch.actions.ClearIndexFolder.class);
    registrator.registerUserAction(globalsearch.actions.DeleteIndex.class);
    registrator.registerUserAction(globalsearch.actions.DrillDownSearch.class);
    registrator.registerUserAction(globalsearch.actions.ExecuteFacetSearch.class);
    registrator.registerUserAction(globalsearch.actions.ExecuteSearch.class);
    registrator.registerUserAction(globalsearch.actions.FileDocumentToIndexData.class);
    registrator.registerUserAction(globalsearch.actions.IndexByEntityName.class);
    registrator.registerUserAction(globalsearch.actions.IndexDataToFileDocument.class);
    registrator.registerUserAction(globalsearch.actions.IndexObject.class);
    ...
    registrator.registerUserAction(oidc.actions.AzureRoleParse.class);
    registrator.registerUserAction(oidc.actions.CallCustomMicroflow.class);
    registrator.registerUserAction(oidc.actions.CreateClaimsString.class);
    registrator.registerUserAction(oidc.actions.CreatePublicJWKKeySet.class);
    registrator.registerUserAction(oidc.actions.DecodeJWT.class);
    registrator.registerUserAction(oidc.actions.DecodeJWTPlainText.class);
    registrator.registerUserAction(oidc.actions.DecodeVerifyJWTPlainText.class);
    registrator.registerUserAction(oidc.actions.Decrypt.class);
    registrator.registerUserAction(oidc.actions.GenerateJWT.class);
    registrator.registerUserAction(oidc.actions.GetCodeChallenge.class);
    registrator.registerUserAction(oidc.actions.GetIssuerFromToken.class);
    registrator.registerUserAction(oidc.actions.GetNonceValue.class);
    registrator.registerUserAction(oidc.actions.GetScopeFromToken.class);
    registrator.registerUserAction(oidc.actions.GetSub.class);
    registrator.registerUserAction(oidc.actions.RoleAssignment.class);
    registrator.registerUserAction(oidc.actions.SetSessionData.class);
    registrator.registerUserAction(system.actions.VerifyPassword.class);
    registrator.registerUserAction(work_management.actions.Java_action.class);
  }
}
